...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden min-h-screen bg-gradient-to-br from-[#f5fcfa] via-white to-[#eef7fc] text-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 xl:px-16 min-h-screen flex flex-col md:flex-row items-center justify-between pt-8 pb-16">
        ...
        <div className="block absolute top-[88%] left-[80%] md:left-[40%] md:top-[49%] z-10 transform -translate-x-1/2 -translate-y-1/2">
        ...
        <Image
          ...
          width={36}
          height={36}
          className="absolute top-22 right-10 animate-bounce z-0"
        />
