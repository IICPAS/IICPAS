    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Build your assignment with tasks, content, simulations, and questions</p>
        </div>
        <button
          onClick={onBack}
      ...
      <div className="bg-white border border-gray-200 rounded-lg">
        ...
        <div className="p-6">
          ...
          {activeTab === "tasks" && (
            <div>
              <div className="flex justify-between items-center mb-4">
                <h4 className="text-lg font-semibold text-gray-800">Assignment Tasks (Pink Banners)</h4>
                <button
                  onClick={addTask}
          ...
          {activeTab === "content" && (
            <div>
              <div className="flex justify-between items-center mb-4">
                <h4 className="text-lg font-semibold text-gray-800">Assignment Content</h4>
                <button
                  onClick={addContent}
                  className="bg-purple-500 text-white px-4 py-2 rounded-lg hover:bg-purple-600 transition-colors"
                >
          ...
          {activeTab === "simulations" && (
            <div>
              <div className="flex justify-between items-center mb-4">
                <h4 className="text-lg font-semibold text-gray-800">Practice Simulations (Optional)</h4>
                <button
          ...
          {activeTab === "questionSets" && (
            <div>
              <div className="flex justify-between items-center mb-4">
                <h4 className="text-lg font-semibold text-gray-800">Assignment Questions (Excel Upload)</h4>
                <button
