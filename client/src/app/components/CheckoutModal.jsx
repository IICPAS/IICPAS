    ...
    <div className="fixed inset-0 backdrop-blur-lg bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      <div className="fixed bottom-6 right-6 z-60">
        <a
          ...
          className="bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out transform hover:scale-110"
                ...
                <div className="bg-gray-50 rounded-lg p-4 sticky top-4">
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                    ...
                    <div className="mt-4 pt-3 border-t border-blue-200">
                      ...
                      <a
                        href="https://wa.me/+918810380146?text=Hi, I need support with my course purchase or payment. Order ID: CANAD%20STUDENT%20COURSES"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg font-medium text-sm transition-colors"
                      >
                        <svg
                          width="16"
                          height="16"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 bg-blue-50 rounded-lg">
                  ...
                  <div className="mt-4 pt-3 border-t border-blue-200">
                    <p className="text-sm text-blue-700 mb-2">
                      Facing issues or need help? Contact our support team:
                    </p>
                    <a
                      href="https://wa.me/+918810380146?text=Hi, I need help with my payment process or course details. Please assist me."
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg font-medium text-sm transition-colors"
                    >
