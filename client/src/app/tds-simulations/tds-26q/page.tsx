...
const TDS26QSimulation: React.FC = () => {
  ...
  const [simulationData, setSimulationData] = useState<TDS26QData>({
    simulationType: "TDS_RETURN_26Q",
    ...
    simulationConfig: {
      ...
      hints: [
        ...
        {
          field: "section",
          hint: "Choose appropriate TDS section based on payment type",
          order: 3,
        },
        {
          field: "tdsRate",
          hint: "TDS rates vary by section and payment amount",
          order: 4,
        },
      ],
      validationRules: {
  ...
  // TDS sections specific to 26Q (non-salary payments)
  const tdsSections = [
    {
      code: "194A",
    ...
    <div className="space-y-6">
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        ...
        <p className="text-green-700 text-sm">
          Add details of persons from whom tax has been deducted (Non-salary
          payments)
        </p>
      </div>
    ...
    <div className="space-y-6">
      <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
        ...
        <p className="text-purple-700 text-sm">
          Review the calculated TDS amounts and totals for non-salary payments
        </p>
      </div>
  ...
  const renderReviewStep = () => (
    <div className="space-y-6">
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        ...
        <p className="text-green-700 text-sm">
          Review all details before submitting the TDS 26Q return
        </p>
      </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-gray-900">
                  TDS 26Q Return Filing Simulation
                </h1>
                <p className="text-sm text-gray-600">
                  Practice TDS return filing for non-salary payments
                </p>
              </div>
...
export default TDS26QSimulation;
