...
const TDS24QSimulation: React.FC = () => {
  ...
  const [simulationData, setSimulationData] = useState<TDS24QData>({
    simulationType: "TDS_RETURN_24Q",
    ...
    simulationConfig: {
      ...
      hints: [
        ...
        {
          field: "pincode",
          hint: "Pincode should be 6 digits starting with 1-9",
          order: 3,
        },
      ],
      validationRules: {
  ...
  const steps = [
    ...
    { id: "tds-calculation", title: "TDS Calculation", completed: false },
    { id: "challan", title: "Challan Details", completed: false },
    { id: "review", title: "Review & Submit", completed: false },
  ];

  const tdsSections = [
    { code: "194A", description: "Interest other than interest on securities" },
    { code: "194B", description: "Winnings from lottery or crossword puzzle" },
    { code: "194C", description: "Payment to contractors" },
    { code: "194D", description: "Insurance commission" },
    { code: "194E", description: "Payment to non-resident sportsmen" },
    { code: "194F", description: "Payment on account of repurchase of units" },
    { code: "194G", description: "Commission on sale of lottery tickets" },
    { code: "194H", description: "Commission or brokerage" },
    { code: "194I", description: "Rent" },
    {
      code: "194J",
      description: "Fees for professional or technical services",
    },
    { code: "194K", description: "Income in respect of units" },
    {
      code: "194L",
    ...
    { code: "194LB", description: "Interest on infrastructure debt fund" },
    { code: "194LC", description: "Interest on loan in foreign currency" },
    { code: "194LD", description: "Interest on rupee denominated bond" },
    {
      code: "194M",
      description: "Payment of certain sum by individual or HUF",
    },
    { code: "194N", description: "Payment of certain amounts in cash" },
    {
      code: "194O",
  ...
  const renderTDSCalculationStep = () => (
    <div className="space-y-6">
    ...
    <div className="space-y-6">
      <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
        ...
        <p className="text-orange-700 text-sm">
          Enter challan details for TDS payment
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input
            type="number"
            value={simulationData.tdsSummary.totalTdsAmount.toFixed(2)}
            readOnly
            className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-50"
          />
        </div>
  ...
  const renderReviewStep = () => (
    <div className="space-y-6">
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        ...
        <p className="text-green-700 text-sm">
          Review all details before submitting the TDS return
        </p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <h5 className="font-medium text-gray-900 mb-2">Deductor Details</h5>
            <div className="space-y-2 text-sm">
              <p>
  ...
  const renderCurrentStep = () => {
    switch (currentStep) {
      ...
      case "tds-calculation":
        return renderTDSCalculationStep();
      case "challan":
            ...
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-gray-900">
                  TDS 24Q Return Filing Simulation
                </h1>
                <p className="text-sm text-gray-600">
                  Practice TDS return filing with realistic scenarios
                </p>
              </div>
...
export default TDS24QSimulation;
